/**
 * Minimal inline brand marks (LinkedIn, GitHub, Instagram) sized to match
 * lucide-react's stroke icons, since current lucide-react no longer ships
 * trademarked brand glyphs.
 */
interface IconProps {
  size?: number;
  className?: string;
